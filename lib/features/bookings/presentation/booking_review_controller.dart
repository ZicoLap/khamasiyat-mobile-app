...
final bookingReviewDraftProvider =
    StateProvider<BookingReviewDraft?>((ref) => null);

/// Last successful PENDING booking waiting for payment.
final pendingBookingSessionProvider =
    StateProvider<PendingBookingSession?>((ref) => null);
